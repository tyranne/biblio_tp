...
CREATE TABLE `book_author` (
  ...
  CONSTRAINT `fk_book` FOREIGN KEY (`fk_book`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `book_author` VALUES (1,25,1),(2,26,2),(3,27,3),(4,28,4),(5,29,5),(6,30,6),(7,31,1);
